...
public class FixedGridLayoutManager extends RecyclerView.LayoutManager {
    ...
    public void setTotalColumnCount(int count) {
        ...
        Log.d(TAG, "setTotalColumnCount: " + mTotalColumnCount);
        requestLayout();
    }
    ...
    public void onLayoutChildren(RecyclerView.Recycler recycler, RecyclerView.State state) {
        ...
        Log.d(TAG, "onLayoutChildren: 1");
        if (getItemCount() == 0) {
            detachAndScrapAttachedViews(recycler);
            return;
        }
        Log.d(TAG, "onLayoutChildren: 2");
        ...
        if (getChildCount() == 0) { //First or empty layout
            ...
            Log.d(TAG, "onLayoutChildren: 4 " + scrap);
            addView(scrap);
            ...
            Log.d(TAG, "onLayoutChildren: 5 " + mDecoratedChildWidth + "--" + mDecoratedChildHeight);
        ...
        if (state.isPreLayout()) {
            ...
            for (int i = 0; i < getChildCount(); i++) {
                Log.d(TAG, "onLayoutChildren: getChildCount() " + i);
            ...
            if (removedCache.size() == 0 && mChangedPositionCount > 0) {
                for (int i = mFirstChangedPosition; i < (mFirstChangedPosition + mChangedPositionCount); i++) {
                    Log.d(TAG, "onLayoutChildren: removedCache() " + i);
    ...
    private void layoutDisappearingView(View disappearingChild) {
        Log.d(TAG, "layoutDisappearingView: "+disappearingChild);
        /*
